 ...
 */
metadata {
	definition (name: "Mbed Temperature Sensor / Switch", namespace: "CR76", author: "Cameron Reid") {
		capability "Polling"
		capability "Refresh"
		capability "Temperature Measurement"
    capability "Switch"

        fingerprint endpointId: "76", profileId: "0104",inClusters: "0000,0006,0402"
	}
...
def parse(String description) {
    ...
    def event = zigbee.getEvent(description) // a
    ...
    else if (description?.startsWith("catchall: 0104 0402 76")) {
...
def refresh() {
	...
	cmd << "st rattr 0x${device.deviceNetworkId} 0x76 0x0006 0x0000"    // Read probe 1 Temperature
}
